...
//
//
//   const ProfileScreen({Key? key, required }) : super(key: key);
//
//   @override
...
//                                       headerChild(
//                                           'Weight',
//                                           userDocument!['weight'].toString() +
//                                               " Kgs"),
//                                       headerChild(
//                                           'Height ',
//                                           userDocument!['height'].toString() +
//                                               " Inch"),
//                                     ]),
//                               ),
//                             ),
...
//                               child: Column(
//                                 children: <Widget>[
//                                   infoChild(_width, Icons.email, globals.login),
//                                   infoChild(_width, Icons.call,
//                                       userDocument!['Phoneno'].toString()),
//
//
//                                 ],
//                               ),
              ...
              builder: (context, userSnapshot) {
                ...
                return StreamBuilder<DocumentSnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection('users')
                      .doc(globals.login)
                      .collection('symptoms').doc('pcos_symptoms')
                      .snapshots(),
                  builder: (context, additionalInfoSnapshot) {
                    if (!additionalInfoSnapshot.hasData) {
                      return Center(child: CircularProgressIndicator());
                    }
                    var additionalInfo= additionalInfoSnapshot.data!;
                    var bmi = userDocument!['BMI'];
                    // Access additionalInfoDocs data as needed
                    return Container(
                      child: Stack(
                        children: <Widget>[
                          Align(
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: <Widget>[
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                        ...
                                        children: <Widget>[
                                          headerChild('BMI',
                                              userDocument['BMI'].substring(0,5)+ "kg/m2"),
                                          headerChild('Acne', additionalInfo['acneLevel']=='1' || additionalInfo['acneLevel']=='2'?"Yes":"No"),
                                          headerChild('Hirsutism', additionalInfo['ferrimanGallweyScore']<=8?"No":"Yes"),
                                        ]),
                                  ),
                                ),
                                Container(
                                ...
                                // Example of using additionalInfoDocs
                                // Padding(
                                //   padding: EdgeInsets.only(top: _height / 20),
                                //   child: Column(
                                //     children: additionalInfoDocs.map((doc) {
                                //       return Text(doc['fieldName']);
                                //     }).toList(),
                                //   ),
                                // ),
                              ],
